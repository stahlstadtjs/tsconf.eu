    ...
    <div class="container p-8 py-32">
      <div class="flex">
        ...
        <div class="w-1/2">
          ...
          <p class="text-blue text-lg pr-32 mb-6">{{blok.text}}</p>
          ...
          <img class="absolute right-0 bottom-0" :src="$options.filters.transformImage(blok.secondary_image, '250x150')"  :alt="blok.secondary_image_alt">
        </div>
      </div>
    </div>
  </div>
