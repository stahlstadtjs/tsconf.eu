<template>
  <div class="ticket-reference" v-editable="blok">
    ...
    <div class="container px-12 my-24">
      ...
      <ul>
        <li v-for="ticket in tickets" :key="ticket._uid" v-editable="ticket.content">
          <div class="flex bg-light-gray mt-6 p-8">
            <div class="w-1/6">
            ...
            <div v-else class="w-2/12 text-center -m-8 bg-red hover:bg-blue text-white min-h-full">
